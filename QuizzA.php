...
<div class="card">  
  ...
  <br>
    <div class="sommaire">
		<h1>Bienvenue sur le Quizz d'Aéronautique</h1>
		...
		<h2 align='center'style='color:#CD6415;'>0.Aimez-vous l'aéronautique ?</h2>
		<h3 align='center'style='color:#8EB9CB;'>
				<INPUT TYPE=RADIO NAME='typeQuizz' VALUE='3' CHECKED id='Vrai'> oui
				<INPUT TYPE=RADIO NAME='typeQuizz' VALUE='3' >   non </h3>
		<?php
